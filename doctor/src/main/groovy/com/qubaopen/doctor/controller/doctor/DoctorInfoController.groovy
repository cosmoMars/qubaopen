...
//	saveBase64Pic(@RequestParam(required = false) String ) {
//		
//	}
//	@RequestMapping(value = 'modifyDoctorInfo', method = RequestMethod.POST, consumes = 'multipart/form-data')
//	saveSinglePic(@RequestParam) {
//		
//	}
		
		@Transactional
		@RequestMapping(value = 'modifyDoctorInfoSingle', method = RequestMethod.POST)
		modifyDoctorInfoSingle(@RequestParam(required = false) String name,
			@RequestParam(required = false) String phone,
			@RequestParam(required = false) String email,
			@RequestParam(required = false) Integer sex,
			@RequestParam(required = false) String birthday,
