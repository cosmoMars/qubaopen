package com.qubaopen.survey.tenpay.util;
...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wxa46025ba7c946c08";//微信开发平台应用id
	public static String APP_SECRET = "446ad95448845342b0fa51c2ddcaa1cf";//应用对应的凭证
	//应用对应的密钥
